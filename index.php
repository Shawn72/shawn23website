...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Shawn23DynastyCo - World Class Applications</title>
                                ...
                                <div class="main_home_slider text-center">
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h1>WELCOME TO SOUTHERN 23DYNASTY CO.</h1>
                                            <p>Always ask for a world class Webapplications</p>
                                            <div class="home_btn">
                                    ...
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h1>WELCOME TO SHAWN 23Dynasty Co.</h1>
                                            <p>Well coded and Tested Apps at your disposal</p>
                                            <div class="home_btn">
                                                <a href="" class="btn btn-primary">LEARN MORE</a>
                                            </div>
                                    ...
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h1>WELCOME TO SOUTHERN 23DYNASTY CO</h1>
                                            <p>World class services available 24/7</p>
                                            <div class="home_btn">
                                                <a href="" class="btn btn-primary">LEARN MORE</a>
                                            </div>
                    ...
                    <div class="main_service_content">
                        <div class="service_tabe">
                            ...
                            <ul class="service_tabe_menu nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#webdesign" aria-controls="webdesign" role="tab" data-toggle="tab"><i class="fa fa-map-marker"></i> <br />WEBSITE DESIGN</a></li>
                                <li role="presentation"><a href="#appdesign" aria-controls="appdesign" role="tab" data-toggle="tab"><i class="fa fa-map-marker"></i> <br />WEB APPLICATIONS</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="single_tab_content">
                                                    ...
                                                    <p>We offer a variety of amazing web designs for businesses, personal sites, blogs as well as
                                                        online E-commerce systems to enable our clients selll their products. </p>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="single_tab_content">
                                                    ...
                                                    <p> We design robust and well tested web applications for clients using hybrib web appplication languages
                                                        as well as various other web development technologies. We integrate the web systems with the client's databases to ensure
                                                        seamless interactions between the web systems and data logics.  </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 wow fadeInRight" data-wow-duration="700ms">
                                <div class="single_about_right_content">
                                    <div class="head_title">
                                        <h3>ABOUT SOUTHERN 23DYNASTYCO</h3>
                                        <div class="separator"></div>
                                    </div>
                                    ...
                                    <div class="single_about">
                                        ...
                                        <div class="single_ab_text">
                                            <h3>WHO IS 23DYNASTYCO</h3>
                                            <p>23DynastyCo is a Web Development company loacted in Nairobi which designs world class
                                                websites and web applications for clients all over the country as well as international clients
                                                on freelance basis.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="single_about">
                                        ...
                                        <div class="single_ab_text">
                                            <h3>AVAILABILITY</h3>
                                            <p>23DynastyCo has a 24/7 service offering as well as instant support on our already deployed Websites and Applications.</p>
                                        </div>
                                    </div>
                                    <div class="single_about">
                                        <div class="single_ab_icon">
